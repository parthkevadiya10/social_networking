...
from .views import SignUpView, LoginView,UserSearchView,FriendListView,PendingFriendRequestView,FriendRequestCreateView,FriendRequestAcceptView,FriendRequestRejectView
